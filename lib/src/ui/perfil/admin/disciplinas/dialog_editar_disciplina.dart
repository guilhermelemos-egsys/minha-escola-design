...
class DialogEditarDisciplina extends StatefulWidget {
  final Disciplina disciplina;

  const DialogEditarDisciplina({Key key, this.disciplina}) : super(key: key);

  @override
  _DialogEditarDisciplinaState createState() => _DialogEditarDisciplinaState();
}

class _DialogEditarDisciplinaState extends State<DialogEditarDisciplina> {
    ...
    return Form(
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            initialValue: widget.disciplina.nomeProfessor,
